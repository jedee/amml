...
function isLate(time: string, threshold = '08:30'): boolean {
  return time > threshold;
}

function calcDur(inTime: string, outTime: string): number {
...
export const SEED_ATTENDANCE: Attendance[] = generate();
