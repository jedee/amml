...
import type { RoleConfig, AuthLevel } from '../types/models';

export const ROLE_CONFIG: Record<AuthLevel, RoleConfig> = {
  SUPERADMIN: {
    label: 'Super Admin',
    short: 'SA',
    color: '#4A148C',
...
export const AUTH_LEVELS: AuthLevel[] = [
  'SUPERADMIN', 'MD', 'MANAGER', 'SUPERVISOR', 'OFFICER',
];

export const LEVEL_LABELS: Record<AuthLevel, string> = {
